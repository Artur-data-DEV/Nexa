...
export const metadata: Metadata = {
  title: "Política de Privacidade - NEXA Platform",
  description: "Conheça como a NEXA coleta, utiliza, armazena e protege seus dados pessoais em conformidade com a LGPD.",
};
