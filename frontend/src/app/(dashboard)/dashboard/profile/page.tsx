...
import { Mail, MapPin, User as UserIcon, Calendar, Edit2, Instagram, Youtube, Facebook, Music4, Twitter,  } from "lucide-react"
          ...
          {!user.has_premium && (
            ...
            <Card>
                ...
                <CardContent className="space-y-3">
                    ...
                    {user.tiktok_handle && (
                        <div className="flex items-center gap-2 text-sm">
                            <Music4 className="h-4 w-4 text-black dark:text-white" />
