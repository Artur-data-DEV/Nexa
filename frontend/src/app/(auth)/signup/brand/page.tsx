      ...
      <Card className="w-full max-w-md">
        ...
        <CardContent>
            ...
            <div className="flex items-center justify-between mb-6 px-2">
                <button
                  type="button"
                  className={`h-2 flex-1 rounded-full ${step >= 1 ? "bg-purple-600" : "bg-gray-200"} cursor-pointer transition-opacity hover:opacity-80`}
                  onClick={() => goToStep(1)}
                  aria-label="Etapa 1"
                  title="Etapa 1"
                />
                <button
                  type="button"
                  className={`h-2 w-2 mx-1 rounded-full ${step >= 2 ? "bg-purple-600" : "bg-gray-200"} cursor-pointer transition-opacity hover:opacity-80`}
                  onClick={() => goToStep(2)}
                  aria-label="Etapa 2"
                  title="Etapa 2"
                />
                <button
                  type="button"
                  className={`h-2 flex-1 rounded-full ${step >= 2 ? "bg-purple-600" : "bg-gray-200"} cursor-pointer transition-opacity hover:opacity-80`}
                  onClick={() => goToStep(2)}
                  aria-label="Etapa 2"
                  title="Etapa 2"
                />
                <button
                  type="button"
                  className={`h-2 w-2 mx-1 rounded-full ${step >= 3 ? "bg-purple-600" : "bg-gray-200"} cursor-pointer transition-opacity hover:opacity-80`}
                  onClick={() => goToStep(3)}
                  aria-label="Etapa 3"
                  title="Etapa 3"
                />
                <button
                  type="button"
                  className={`h-2 flex-1 rounded-full ${step >= 3 ? "bg-purple-600" : "bg-gray-200"} cursor-pointer transition-opacity hover:opacity-80`}
                  onClick={() => goToStep(3)}
                  aria-label="Etapa 3"
                  title="Etapa 3"
                />
