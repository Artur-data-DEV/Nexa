...
export const Testimonials = () => {
    ...
    return (
        <section className=" bg-background relative overflow-hidden">
            {/* Background elements */}
            <div className="absolute top-0 right-1/4 w-150 h-150 bg-pink-500/5 rounded-full blur-[120px] -z-10" />
            <div className="absolute bottom-0 left-1/4 w-150 h-150 bg-purple-600/5 rounded-full blur-[120px] -z-10" />
            ...
            <div className="max-w-7xl mx-auto px-4 md:px-6">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 gap-8 relative">
                    ...
                    <div className="flex flex-col gap-6 h-150 overflow-hidden relative">
                        <motion.div
                            animate={{ y: ["0%", "-50%"] }}
                    ...
                    <div className="hidden md:flex flex-col gap-6 h-150 overflow-hidden relative">
                        <motion.div
                            animate={{ y: ["-50%", "0%"] }}
